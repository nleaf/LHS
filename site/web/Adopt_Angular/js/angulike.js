                  ...
                  link: function (scope, element, attrs) {
                      ...
                      function renderLikeButton() {
                          if (!!attrs.fbLike && !scope.fbLike && !watchAdded) {
                              ...
                              element.html('<div class="fb-like"' + (!!scope.fbLike ? ' data-href="' + scope.fbLike + '"' : '') + ' data-colorscheme="light" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>');
                  ...
                  link: function (scope, element, attrs) {
                      ...
                      function renderTweetButton() {
                          if (!scope.tweet && !watchAdded) {
                              ...
                              element.html('<a href="https://twitter.com/share" class="twitter-share-button" data-text="' + scope.tweet + '" data-url="' + scope.tweeturl + '" data-via="' + scope.tweethandle + '" data-related="' + scope.tweethandle + '">Tweet</a>');
